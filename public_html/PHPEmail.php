...
echo "<p>The \"CC\" e-mail addresses contain duplicates. Click your browser's Back but
ton to return to the message.</p>";
...
If($MessageSent)
{
echo "<p>The following message was sent sucessfully;</p><hr />";
...
echo "<p>The message was not sent sucessfully!</p>";
}
